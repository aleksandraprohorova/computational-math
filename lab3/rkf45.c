...
/* Purpose ...
   ...
   single step in the direction of TOUT. On return 0 the parameters in
   ...
   *RELERR,
   ABSERR  : relative and absolute error tolerances for local
	     ...
	     RELERR appropriately and return 0s control to the user before
   ...
   *T      : independent variable, final value reached
	     ...
	     rkf45() return 0s with IFLAG = 2 if continuation is possible.
   *IFLAG  : indicator for status of integration
	      = 2 : Integration reached TOUT. Indicates successful return 0
   ...
   -------------------------
   Function rkf45() return 0s with all information needed to continue
...
/* If too close to output point, extrapolate (linearly) and return 0  */
...
/* Fehlberg fourth-fifth order Runge-Kutta method
   ...
   the solution over the fixed step H and return 0s
